...
if [ $SYS = "Linux" ]; then
    DEFS=NVLinux
    LIBRARIES="-L $PFM_LIB -lbag -lchrtr2 -lnvutility -lbag -lbeecrypt -lhdf5 -lgdal -lxml2 -lpoppler -lGLU -ldl -lstdc++"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="WIN32 NVWIN3X"
    LIBRARIES="-L $PFM_LIB -lbag -lchrtr2 -lnvutility -lbag -lbeecrypt -lhdf5 -lgdal -lxml2 -lpoppler -lwsock32 -liconv"
