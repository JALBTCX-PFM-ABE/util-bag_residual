...
#define     VERSION     "PFM Software - bag_residual V1.04 - 07/23/14"
...
/*
    ...
    Now compares grids that are off by less than 2 in width and height but have identical lower left corners and X and Y bin sizes.
